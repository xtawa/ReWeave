        ...
        <Layout title={title} url={slug ? `/${slug}` : undefined}>
            ...
            <main class="space-y-6">
                <section class="bg-black/40 border border-emerald-500/20 rounded-none p-5 md:p-8">
                    ...
                    <div class="prose prose-invert prose-zinc max-w-none font-mono prose-headings:text-zinc-100 prose-p:text-zinc-300 prose-a:text-emerald-400 hover:prose-a:text-cyan-300" dangerouslySetInnerHTML={{ __html: content }} />
                </section>
