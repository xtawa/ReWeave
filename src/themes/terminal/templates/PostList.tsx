                    ...
                    return (
                        <article class="bg-black/40 border border-emerald-500/20 rounded-none p-4">
                            ...
                            <h2 class="text-xl text-zinc-100 mb-2">
                                <a href={`/posts/${postUrl}`} class="no-underline hover:text-cyan-300 border-b border-transparent hover:border-cyan-400"> 
                            ...
                            {post.tags && post.tags.length > 0 && (
                                <div class="mt-3 flex flex-wrap gap-2">
                                    {post.tags.map((tag) => (
                                        <a href={`/tags/${safeSlug(tag)}`} class="text-xs border border-emerald-500/30 px-2 py-1 text-zinc-300 no-underline hover:border-cyan-400 hover:text-cyan-300">
                                            #{tag}
                                        </a>
                                    ))}
                                </div>
